...
def write_report(output_dir):
    ...
    text = '\n\n'.join([
        ...
        'Codex assisted with implementation and interpretation. This phase makes no LLM calls, creates no relevance labels, and uses no behavioral features in ranking. No learned reranker was added: the fixed-component experiment directly tests marginal signal contributions.',
